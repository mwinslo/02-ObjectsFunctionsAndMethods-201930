...
def main():
    ...
    #better_draw_circles(rg.Point(100, 50), 30)
    #better_draw_circles(rg.Point(-200, 0), 30)
    #even_better_draw_circles(rg.Point(100, 50), 30, 5, "red", 10)
    #even_better_draw_circles(rg.Point(-200, 0), 30, 6, "blue", 4)
    even_better_draw_circles(rg.Point(0, 0), 30, 5, "red", 10)
    even_better_draw_circles(rg.Point(0, 0), 25, 5, "orange", 10)
    even_better_draw_circles(rg.Point(0, 0), 20, 5, "yellow", 10)
    even_better_draw_circles(rg.Point(0, 0), 15, 5, "green", 10)
    even_better_draw_circles(rg.Point(0, 0), 10, 5, "blue", 10)
    even_better_draw_circles(rg.Point(0, 0), 5, 5, "purple", 10)
    window.update()
...
def even_better_draw_circles(point, radius, number, color, thickness):
        turtle = rg.SimpleTurtle()
        ...
        for number in range(1, 11):  # k becomes 1, 2, 3, ... 10
            ...
            turtle.pen_down()
            turtle.draw_circle(radius * number)  # Radius 15, 30, 45, 60, ...
