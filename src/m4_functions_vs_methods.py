...
def try_methods():
    hello = rg.SimpleTurtle()
    hello.pen = rg.Pen("brown", 5)
    hello.forward(100)
    hello.left(90)
    hello.forward(100)
    hello.backward(50)
...
def try_methods_and_functions():
    reptile = rg.SimpleTurtle()
    reptile.pen = rg.Pen("blue", 5)
    reptile.backward(150)
    reptile.speed = 1
    draw_many_squares(reptile, 2, 100, 30)
    reptile.speed = 5
    reptile.pen = rg.Pen("red", 5)
    draw_many_squares(reptile, 10, 50, 15)
    reptile.speed = 100
    reptile.pen = rg.Pen("red", 35)
    draw_many_squares(reptile, 8, 300, 60)
    reptile.pen = rg.Pen("black", 3)
    reptile.backward(200)
    reptile.draw_circle(30)
    reptile.draw_square(50)
    """
    Constructs a SimpleTurtle and sets its   pen  to a new rg.Pen
